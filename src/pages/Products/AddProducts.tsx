                    ...
                    <form action="" className="text-[12px] font-[600] text-neutral-800 flex flex-col gap-[4px]">
                        <div className="flex gap-[10px]">
                            ...
                            <div className="flex flex-col">
                                ...
                                <Input type="text" width="288px" id="namaProduk" name="namaProduk"/>
                            </div>
                        </div>
                        <div className="flex gap-[10px]">
                            <div className="flex flex-col">
                                <label htmlFor="harga">Harga</label>
                                <Input type="number" width="189px" id="harga" name="harga"/>
                            </div>
                            <div className="flex flex-col">
                                <label htmlFor="stok">Stok</label>
                                <Input type="number" width="189px" id="stok" name="stok"/>
                            </div>
                            <div className="flex flex-col">
                                <label htmlFor="koin">Koin</label>
                                <Input type="number" width="189px" id="koin" name="koin"/>
                            </div>
                        </div>
                        <div className="flex flex-col">
                            <label htmlFor="deskripsi">Deskripsi</label>
                            <Textarea height="121px" width="587px" id="deskripsi" name="deskripsi"/>
                        </div>
