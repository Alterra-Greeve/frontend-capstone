...
export default function AddProducts() {
    ...
    function handleCheck(e) {
        ...
        checked
            ...
            : setNewData({ ...newData, category: newData.category.filter((item) => item !== value) });
    }
        ...
        <AdminLayout>
            <div className="flex flex-col gap-[16px] bg-neutral-100 p-[24px] h-[calc(100vh-90px)]">
                <div className="flex justify-between">
                    <button
                        className="p-[8px] flex gap-[4px] items-center text-neutral-900 text-[14px] font-[500]"
                ...
                <div className="flex flex-col">
                    ...
                    <span className="rounded-[7px] bg-neutral-300 p-[8px] w-[328px]">
                        <span className="text-[12px] font-[500] text-neutral-500">{currentDate}</span>
                    </span>
                </div>
                <form className="flex gap-[10px]">
                    <div className="bg-neutral-50 p-[4px] border-[0.5px] border-solid border-[#17171712] rounded-[8px] h-[418px] w-[539px]">
                    ...
                    <div className="text-[12px] font-[600] text-neutral-800 flex flex-col gap-[8px]">
                        <div className="flex flex-col">
                        ...
                        <div>
                            ...
                            <ul className="flex flex-col">
                                <li className="flex gap-[8px] py-[4px] px-[8px] items-center">
                                    <input type="checkbox" name="Pemanasan Global" id="" value="b5d07366-3b31-4011-95e3-34735b0b61f8" onChange={handleCheck} />
                                ...
                                <li className="flex gap-[8px] py-[4px] px-[8px] items-center">
                                    <input type="checkbox" name="Hemat Uang" id="" value="83808762-e2b8-4b34-a1eb-0ed8d4fda3dd" onChange={handleCheck} />
                                    <div className="p-[4px] flex gap-[4px] items-center">
                                        <CatMoney />
                                ...
                                <li className="flex gap-[8px] py-[4px] px-[8px] items-center">
                                    <input type="checkbox" name="Memperluas Wawasan" id="" value="e8e714bd-c34e-4278-980c-39bd1f55b5fb" onChange={handleCheck} />
                                    <div className="p-[4px] flex gap-[4px] items-center">
                                        <CatBrain />
                                ...
                                <li className="flex gap-[8px] py-[4px] px-[8px] items-center">
                                    <input type="checkbox" name="Mengurangi Limbah" id="" value="7d34a5fa-e2cf-466d-9f01-d731f6967082" onChange={handleCheck} />
                                    <div className="p-[4px] flex gap-[4px] items-center">
                                        <CatRecycle />
            ...
            {isVisible ?
                <ModalAlerts className="rounded-[20px] bg-neutral-50 max-w-[500px] max-h-[440px] p-[32px] flex flex-col items-center gap-[32px]">
                    <YesOrNo />
                    ...
                    <div className="flex gap-[24px]">
                        <Button variant="secondary" className='w-[206px] py-[12px]' onClick={() => setIsVisible(false)}>Tidak</Button>
                        <Button variant="primary" className='w-[206px] py-[12px]' onClick={handlePost}>Iya, Simpan</Button>
                    </div>
                </ModalAlerts>
                : null}
            {isSaved ?
                <ModalAlerts className="rounded-[20px] bg-neutral-50 max-w-[500px] max-h-[440px] p-[32px] flex flex-col items-center gap-[32px]">
                    ...
                    <div className="flex gap-[24px]">
                        <Link to='/dashboard/products/'>
                            <Button variant="primary" className='w-[336px] py-[12px]' onClick={() => setIsSaved(false)}>Tutup</Button>
                        </Link>
                    </div>
                </ModalAlerts>
                : null}
