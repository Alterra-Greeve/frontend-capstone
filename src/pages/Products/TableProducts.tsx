...
export default function TableProducts({ data, dataShow, filterValue, isFiltered }: any) {
                    ...
                    <TableBody>
                        {
                            data.data.map((item: any, i: any) => {
                                if (i > dataShow.Start && i < dataShow.end) {
                                    if (item.price >= filterValue?.minPrice && item.price <= filterValue?.maxPrice 
                                        && item.stock >= filterValue?.minStock && item.stock <= filterValue?.maxStock
                                        && item.coin >= filterValue?.minCoin && item.coin <= filterValue?.maxCoin) {
                                        return (
