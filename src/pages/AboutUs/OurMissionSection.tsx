...
const OurMissionSection = () => {
  return (
    <section className="bg-primary-50 py-[60px] px-[64px] flex flex-col xl:flex-row justify-between gap-[60px]">
      <div className="flex flex-col gap-[32px]">
        <div className="flex flex-col md:flex-row justify-start gap-[32px]">
          <img
            className="w-[306px] h-auto md:h-[309px]"
            src={image2}
            alt="image2"
          />
          <img
        ...
        <img
          className="w-[644px] h-auto md:h-[309px]"
          src={image1}
          alt="image1"
        />
      </div>
      <div className="max-w-[604px] flex flex-col justify-center">
        ...
        <p className="text-neutral-600 text-[16px] md:text-[25px] font-normal text-justify">
          Misi kami adalah memberdayakan individu untuk membuat pilihan yang
          berkelanjutan dan berkontribusi pada planet yang lebih sehat. Karena
