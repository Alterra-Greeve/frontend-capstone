...
const featureItem: featureItemProps[] = [
  { feature: "Tolak hingga 5 kartu challenge" },
  { feature: "Ambil 5 kartu challenge" },
  { feature: "Tiga kesempatan shuffle gratis!" },
  { feature: "Nikmati voucher diskon lebih besar" },
];
...
const PaketCard = ({
  ...
  return (
    <Card className="w-[275px] md:w-[352px] shadow-lg border-0">
      <CardHeader className="flex flex-col gap-[17px]">
        ...
        <CardDescription>
          <div className="flex flex-row h-auto gap-[4px] ">
            <h6 className="text-neutral-900 text-[36px] font-medium">
              Rp{price}
            </h6>
          ...
          {isHemat ? (
            <p className="text-neutral-600 text-[16px] mt-[17px] font-normal">
              Hemat {waktuHemat} bulan! Dapatkan akses penuh selama {waktuAkses}{" "}
              bulan.
            </p>
          ) : (
            <p className="text-neutral-600 text-[16px] font-normal mt-[17px] mb-[24px]">
              Dapatkan akses penuh selama {waktuAkses} bulan.
            </p>
          )}
        </CardDescription>
        <Button
          ...
          variant="outline"
          className="hover:bg-primary-500 border-primary-500 rounded-[40px] mb-[27px] p-[8px] hover:text-neutral-100 text-primary-500 text-[14px] font-medium"
        >
          Mulai Sekarang
        </Button>
        <hr />
      ...
      <CardContent>
        <p className="text-neutral-600 text-[16px] font-normal mb-[13px]">
          Apa yang termasuk:
        </p>
        {featureItem.map((item, index) => (
          <div key={index} className="flex justify-start gap-[6px] mb-[6px]">
            <img src={tick} alt="tick" />
            <p className="text-primary-500 text-[16px] font-normal">
              {item.feature}
            </p>
          </div>
        ))}
