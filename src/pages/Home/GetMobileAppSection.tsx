...
import apple from "../../assets/icons/Appe.svg";
  ...
  return (
    <section className="relative bg-primary-50 pt-[48px] pb-[882px] h-[1177px] flex flex-col justify-center items-center gap-[35px]">
      ...
      <div className="flex flex-row justify-center items-center gap-[12px]">
        <Link to={"/"}>
          <Button className="w-[272px] h-auto bg-primary-500 hover:bg-primary-600 p-[20px] rounded-[40px] text-neutral-100 text-[24px] font-semibold">
            <img className="w-[32px] h-[32px]" src={apple} alt="apple" />
            Download Now
          </Button>
        </Link>
        <Link to={"/"}>
          <Button className="w-[272px] h-auto bg-primary-500 hover:bg-primary-600 p-[20px] rounded-[40px] text-neutral-100 text-[24px] font-semibold">
            <img className="w-[32px] h-[32px]" src={playstore} alt="playstore" />
            Download Now
          </Button>
        </Link>
      </div>
      <div className="absolute z-50 bottom-[250px] w-[250px] h-auto left-64 bg-[#FFF] rounded-[10px] shadow-md p-[15px] flex flex-col gap-[10px]">
        <div className="flex gap-[6px] items-center">
          ...
          <h5 className="text-neutral-900 text-[20px] font-normal">Lee John Doe</h5>
        </div>
        <h5 className="text-neutral-900 text-[20px] font-normal">Greeve Koinmu!</h5>
        ...
        <div className="flex gap-[6px] justify-between items-center">
          <div>
            <p className="text-neutral-900 text-[10px] font-normal">ID Pengguna</p>
      ...
      <Helps image={helps1} name="Less Global Warming" className="absolute bottom-[500px] right-[230px]" />
      <Helps image={helps2} name="Save Money" className="absolute bottom-[750px] right-40" />
      <Helps image={helps3} name="Expand Your Main" className="absolute bottom-[630px] right-[350px]" />
      <Helps image={helps4} name="Less Waste" className="absolute bottom-[350px] right-40" />
    </section>
  );
};
