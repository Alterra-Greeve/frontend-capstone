...
const AboutUsSection = () => {
  return (
    <section
      id="About Us"
      className="flex px-[64px] py-[56px] items-center justify-between 2xl:justify-center 2xl:gap-[250px] gap-[50px] relative"
    >
      <div className="relative">
        <div className="bg-primary-50 w-[515px] h-[700px] rounded-[30px]">
          <img
            className="w-[598px] h-auto absolute bottom-0 left-[70px]"
            src={womanWithPhone}
            alt="woman with phone"
          />
          <Helps
            className="absolute bottom-[500px] -right-10"
            image={helps1}
            name="Less Global Warming"
          />
          <Helps
            className="absolute bottom-[400px] -right-24"
            image={helps2}
      ...
      <div className="max-w-[664px]  h-auto">
        <h3 className="text-neutral-900 text-[60px] font-semibold mb-[17px]">
          About Us
        </h3>
        <p className="text-neutral-600 text-[25px] font-normal mb-[50px] text-justify">
        ...
        <Link to={"/about-us"}>
          <Button className="bg-primary-500 hover:bg-primary-600 p-[20px] w-[272px] h-auto rounded-[40px] text-neutral-100 text-[24px] font-semibold">
            Selengkapnya
          </Button>
        </Link>
      </div>
