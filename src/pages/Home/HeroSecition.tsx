  ...
  return (
    <section className="flex justify-between py-[60px] px-[64px] relative">
      ...
      <div className="w-[613px] flex px-[24px] flex-col justify-start gap-[45px] mt-[50px]">
        ...
        <Button className="bg-primary-500 hover:bg-primary-600 p-[20px] w-[272px] h-auto rounded-[40px] text-neutral-100 text-[24px] font-semibold">Mulai Sekarang</Button>
      </div>
      <div>
