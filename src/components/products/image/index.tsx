...
export const SelectChildImage = ({ onSaveFile, disabled }: { onSaveFile: (file: File) => void; disabled: boolean; }) => {
  ...
  return (
    <div
      ...
      className={`${disabled ? "bg-neutral-100" : "border-[2px] border-dashed border-primary-500 bg-primary-50"} flex justify-center items-center rounded-xl w-full h-24 transition-all hover:cursor-pointer hover:bg-neutral-100`}>
